...
uint128_t deleglise_rivat128::A_cpu()
{
  ...
  uint64_t upper_bound = pow(sqrtx, (double)0.75); // x^(3/8)
  ...
  uint64_t * lastQ = (uint64_t *)malloc(num_p * sizeof(uint64_t));
  ...
  PiTable pi_table(sqrtx, upper_bound);
